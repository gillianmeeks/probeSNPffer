...
```
## Installation
probeSNPffer is available at [https://bioconductor.org](https://bioconductor.org) and can be
installed via:
...
CpG_SNP_intersection <- CpG_SNP_intersection[CpG_SNP_intersection$col_chan_switching!= FALSE,]
```
